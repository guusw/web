...
<p>
For the networking side, I wrote a basic encryption layer for the packet using RSA as a key exchange system and AES for all the game packets. I wrote this system from scratch to figure out the implementations of public key cryptography and symmetric key cryptography.
</p>
